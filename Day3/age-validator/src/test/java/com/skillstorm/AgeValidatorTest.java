...
/**
 * JUNIT - unit testing framework - unit testing is testing the individual
 * components to ensure they work as intended
 * 
 * JUNIT ANNOTATIONS BeforeClass Before Test Ignore After AfterClass
 * 
 * if you have multiple methods of the same annotation type, JUNIT does not
 * guarentee the order that the matching annotations will run
 * 
 */
...
public class AgeValidatorTest {
    ...
    /**
     * BeforeClass and Before - these are setup methods used to initialize data you
     * will use within your tests
     * 
     * BeforeClass - run once before all of the other methods ex: to setup a datbase
     * connection
     * 
     * Before - will run right before each test ex: load data from the database
     */
    ...
    /**
     * tests either pass or fail tests only fail if an exception is thrown and is
     * unhandled
     * 
     * junit has assertion methods to throw exceptions for you - they don't return
     * anything
     */
    ...
    public void testOldEnoughToDrive() {
        try {
            ...
            // throw new InvalidAgeException("Must be at least 21 years old to buy
            // alcohol!");
    ...
    // A test method without the try-catch
    @Test
    ...
    /**
     * After and AfterClass these are teardown methods taht are used to
     * delete/rollback things that were setup
     * 
     * After - run after each test has finished AfterClass - will run once at the
     * end of all test being finsihed
     */
